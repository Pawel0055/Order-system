            ...
            <div class="container content">
                ...
                <div class="row">
                    <div class="col-xs-5 col-xs-offset-3">
                        <h2 class="table-caption">Zamowienie dla: <?= $data['dane_o_kliencie'][0]['imie'] . ' ' . $data['dane_o_kliencie'][0]['nazwisko'] . ' ' . $data['dane_o_kliencie'][0]['adres'] . ' Telefon: ' . $data['dane_o_kliencie'][0]['telefon']  ?></h2>
                    </div>
                </div>
                <div class="container edits">
					...
					<div class="col-xs-4 col-xs-offset-4">
                        <form action="/magiste/mgr/mvc/public/zamowienia_dostawcy/del" method="post">
                            <button class="btn btn-primary" type="submit" name="zamowienie" value="<?=$data['wynik'][0]['id_zamowienia']?>">Zrealizowano</button>
                        </form>
                    </div>
                </div>
                <div class="row form">
